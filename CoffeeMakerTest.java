...
public class CoffeeMakerTest extends TestCase {
	...
	//amount paid > price = generates change(repeat multiple times so that the inventory gets low)
	cm.addRecipe(r1);
	...
	cm.addRecipe(r1);
	assertEquals(25, cm.makeCoffee(0, 75));
	//informs non existing recipe ("9") = returns money 
	cm.addRecipe(r1);
	assertEquals(75, cm.makeCoffee(9, 75));
	
	cm.addRecipe(r1);
	assertEquals(25, cm.makeCoffee(0, 75));
	//ingredients in inventory aren't sufficient to make coffee recipe = returns money
	cm.addRecipe(r1);
